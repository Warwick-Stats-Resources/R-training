...
Please ensure that you have the latest versions of R and RStudio installed prior to the first session. Currently, that's R-4.2.1 and RStudio-2022.07.2. You will also need to install Quarto for the final session of the term.
...
Quarto can be downloaded from <https://quarto.org/docs/get-started/>. Choose the appropriate installer for your operating system. 
